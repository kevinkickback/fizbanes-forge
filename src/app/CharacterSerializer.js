...
export function serialize(character) {
    ...
    const serializedData = {
        ...
        speed: character.speed ? { ...character.speed } : { walk: 30, fly: 0, swim: 0, climb: 0, burrow: 0 },
    ...
    if (character.pendingAbilityChoices && Array.isArray(character.pendingAbilityChoices)) {
    ...
    if (character.instrumentChoices && Array.isArray(character.instrumentChoices)) {
        serializedData.instrumentChoices = character.instrumentChoices.map((slot) => ({
            key: slot.key,
    ...
    serializedData.inventory = {
        ...
        equipped: character.inventory?.equipped ? { ...character.inventory.equipped } : {},
    ...
    serializedData.spellcasting = {
        classes: character.spellcasting?.classes ? { ...character.spellcasting.classes } : {},
