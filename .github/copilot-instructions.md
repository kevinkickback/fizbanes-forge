...
Consult the architecture map in [docs/CODEBASE_ARCHITECTURE.md](../docs/CODEBASE_ARCHITECTURE.md) before editing any file to understand cross-file dependencies and required collaborators.
