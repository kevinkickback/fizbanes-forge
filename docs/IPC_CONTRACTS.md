...
- Note: [PORTRAITS_GET_DIRECTORY](src/main/ipc/channels.js#L32) / [PORTRAITS_SET_DIRECTORY](src/main/ipc/channels.js#L33) have no registered handlers currently.

## Equipment (placeholders)
Handlers exist but return "not implemented".
- **Add Item**: [channels](src/main/ipc/channels.js#L49) → [src/main/ipc/EquipmentHandlers.js](src/main/ipc/EquipmentHandlers.js#L8)
  - Request: `characterId: string`, `itemData: object`
  - Response: `{ success: false, error }`
- **Remove Item**: [channels](src/main/ipc/channels.js#L50) → [EquipmentHandlers](src/main/ipc/EquipmentHandlers.js#L36)
  - Request: `characterId: string`, `itemInstanceId: string`
  - Response: `{ success: false, error }`
- **Equip/Unequip/Attune/Unattune**: [channels](src/main/ipc/channels.js#L51-L54) → [EquipmentHandlers](src/main/ipc/EquipmentHandlers.js#L59)
  - Request: varies
  - Response: `{ success: false, error }`
- **Calculate Weight / Check Encumbrance**: [channels](src/main/ipc/channels.js#L55-L56) → [EquipmentHandlers](src/main/ipc/EquipmentHandlers.js#L115)
  - Request: varies
  - Response: `{ success: false, error }`

## Spells (placeholders)
Handlers exist but return "not implemented".
- **Initialize Class**: [channels](src/main/ipc/channels.js#L63) → [src/main/ipc/SpellHandlers.js](src/main/ipc/SpellHandlers.js#L8)
  - Request: `characterId: string`, `className: string`
  - Response: `{ success: false, error }`
- **Add/Remove Known, Prepare/Unprepare, Use/Restore Slots**: [channels](src/main/ipc/channels.js#L57-L62) → [SpellHandlers](src/main/ipc/SpellHandlers.js#L26)
  - Request: varies
  - Response: `{ success: false, error }`

## Progression (placeholders)
Handlers exist but return "not implemented".
- **Increase/Decrease Level**: [channels](src/main/ipc/channels.js#L66-L67) → [src/main/ipc/ProgressionHandlers.js](src/main/ipc/ProgressionHandlers.js#L8)
  - Request: `characterId: string`
  - Response: `{ success: false, error }`
- **Add/Remove Class Level**: [channels](src/main/ipc/channels.js#L68-L69) → [ProgressionHandlers](src/main/ipc/ProgressionHandlers.js#L36)
  - Request: `characterId: string`, `className: string`
  - Response: `{ success: false, error }`
- **Calculate HP**: [channels](src/main/ipc/channels.js#L70) → [ProgressionHandlers](src/main/ipc/ProgressionHandlers.js#L86)
  - Request: `characterId: string`, `classData: object`
  - Response: `{ success: false, error }`
