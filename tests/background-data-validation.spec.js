...
test.describe('Background Data Validation', () => {
    ...
    test('Load Acolyte background JSON directly', async () => {
        ...
        if (backgroundJson.error) {
            ...
            console.log('Has Language Proficiencies:', backgroundJson.hasLanguageProficiencies);
            console.log('Has Skill Proficiencies:', backgroundJson.hasSkillProficiencies);
            console.log('Has Tool Proficiencies:', backgroundJson.hasToolProficiencies);
