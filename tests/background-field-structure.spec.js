...
test('Inspect actual background field structure', async () => {
    ...
    console.log('startingEquipment:', JSON.stringify(bgData.startingEquipment, null, 2));
    console.log('languageProficiencies:', JSON.stringify(bgData.languageProficiencies, null, 2));
    console.log('skillProficiencies:', JSON.stringify(bgData.skillProficiencies, null, 2));
    console.log('toolProficiencies:', JSON.stringify(bgData.toolProficiencies, null, 2));
