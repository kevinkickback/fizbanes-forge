...
test.describe('Tooltip integration (Electron)', () => {
    test('shows Fireball tooltip content without errors', async () => {
        ...
        try {
            ...
            const fireballLink = page.locator('.reference-link', { hasText: 'Fireball' }).first();
    ...
    test('shows different tooltip types (spell, item, condition)', async () => {
        ...
        try {
            ...
            // Test spell tooltip
            const spellLink = page.locator('.reference-link[data-hover-type="spell"]').first();
            ...
            const conditionLink = page.locator('.reference-link[data-hover-type="condition"]').first();
