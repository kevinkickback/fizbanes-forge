...
test.describe('Tag Handler Coverage (Extended)', () => {
    test('resolves skill references (Perception, Stealth, Athletics)', async () => {
        ...
        try {
            ...
            await page.waitForSelector('button.nav-link[data-page="tooltipTest"]', { timeout: 60000 });
            await page.click('button.nav-link[data-page="tooltipTest"]');
            await page.waitForSelector('h1:has-text("Tooltip System Test Page")', { timeout: 60000 });

            // Test skill tooltip
            const skillLink = page.locator('.reference-link[data-tooltip-type="skill"]').first();
    ...
    test('resolves action references (Dash, Dodge, Help)', async () => {
        ...
        try {
            ...
            // Test action tooltip
            const actionLink = page.locator('.reference-link[data-tooltip-type="action"]').first();
    ...
    test('resolves feat references with proper rendering', async () => {
        ...
        try {
            ...
            // Test feat tooltip
            const featLink = page.locator('.reference-link[data-tooltip-type="feat"]').first();
    ...
    test('resolves background references', async () => {
        ...
        try {
            ...
            const backgroundLink = page.locator('.reference-link[data-tooltip-type="background"]').first();
