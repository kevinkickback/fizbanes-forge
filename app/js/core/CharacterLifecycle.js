...
class CharacterLifecycle {
    /**
     * Initializes a new CharacterLifecycle instance
     * @private
     */
    constructor() {
        /**
    ...
    set currentCharacter(character) {
        ...
        try {
            ...
            if (character?.variantRules?.abilityScoreMethod) {
                ...
                import('../services/AbilityScoreService.js').then(({ abilityScoreService }) => {
...
export const characterLifecycle = new CharacterLifecycle();
// Export with old name for backward compatibility during transition
export const characterHandler = characterLifecycle;
