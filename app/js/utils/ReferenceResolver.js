...
export class ReferenceResolver {
    ...
    async resolveCondition(conditionName) {
        try {
            ...
            const condition = data.condition?.find(c =>
    ...
    async resolveBackground(backgroundName, source = "PHB") {
        try {
            ...
            const background = allBackgrounds?.find(b =>
                b.name.toLowerCase() === backgroundName.toLowerCase()
            );
    ...
    async resolveAction(actionName) {
        try {
            ...
            const action = data.action?.find(a =>
