...
export class SourcePickerView {
     ...
     */
    renderSourceToggles(container, availableSources, formatSourceName, onToggleClick) {
        container.innerHTML = '';
        const toggles = [];

        for (const source of availableSources) {
            const toggle = this.createSourceToggle(source, formatSourceName, onToggleClick);
