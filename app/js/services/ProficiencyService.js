...
export class ProficiencyService {
    ...
    setOptionalProficiencies(character, type, source, allowed, options) {
        return ProficiencyCore.setOptionalProficiencies(character, type, source, allowed, options);
    }
    ...
    getAvailableOptionalProficiencies(character, type, source) {
        return ProficiencyCore.getAvailableOptionalProficiencies(character, type, source);
    }
    ...
    selectOptionalProficiency(character, type, source, proficiency) {
        return ProficiencyCore.selectOptionalProficiency(character, type, source, proficiency);
    }
    ...
    deselectOptionalProficiency(character, type, source, proficiency) {
        return ProficiencyCore.deselectOptionalProficiency(character, type, source, proficiency);
    }
