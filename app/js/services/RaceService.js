...
class RaceService {
    ...
    getRace(name, source = 'PHB') {
        ...
        return this._raceData.race.find(r =>
    ...
    getSubraces(raceName, source = 'PHB') {
        ...
        if (this._raceData?.subrace) {
            ...
            const raceSubraces = this._raceData.subrace.filter(sr =>
        ...
        const subraceEntry = this._raceData?.subrace?.find(sr =>
            sr.raceName === raceName &&
            (sr.raceSource === source || !sr.raceSource) &&
            sr._versions
        );
    ...
    getRaceFluff(raceName, source = 'PHB') {
        ...
        return this._raceData.raceFluff.find(f =>
            f.name === raceName && f.source === source
        ) || null;
    }
